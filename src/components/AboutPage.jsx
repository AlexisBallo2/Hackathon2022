...
const AboutPage = () => {
  return (
    <div className={styles.aboutPage}>
      ...
      <div></div>
      <div className={styles.div}><h1 className = {styles.h1}>About Midd XChange</h1>
      <p>
        The Middlebury community has long been in need of a centralized website
        to connect people through an informal market economy. Midd XChange seeks
      ...
      <p>
        ...
        seller. To add a post, sellers can click the "list item" button
        conveniently located in the top-left corner of our website. After
      ...
      <p>
        ...
        lessons, seniors getting rid of items for graduation, spike-ball nets
